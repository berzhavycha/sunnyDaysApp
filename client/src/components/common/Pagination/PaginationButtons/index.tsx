...
export const PaginationButtons: FC<Props> = ({ startPageNumber, currentPage, paginationPageNumbers, onClickPageButton, onClickNext, onClickPrev, totalPages }): JSX.Element => {
    ...
    return (
        <View className='w-full flex flex-row justify-center pb-4'>
            <TouchablePaginationButton
                ...
                isNavigator
            />
            <PaginationPageButtons currentPage={currentPage} paginationPageNumbers={paginationPageNumbers} onClickPageButton={onClickPageButton} />
            <TouchablePaginationButton

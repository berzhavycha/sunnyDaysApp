...
export const JWT_REFRESH_SECRET = configService.get<string>('JWT_REFRESH_SECRET') 
export const REDIS_HOST = configService.get<string>('REDIS_HOST') 
export const REDIS_PORT = configService.get<string>('REDIS_PORT') 
export const JWT_ACCESS_TOKEN_TIME = configService.get<string>('JWT_ACCESS_TOKEN_TIME') 
export const JWT_REFRESH_TOKEN_TIME = configService.get<string>('JWT_REFRESH_TOKEN_TIME') 

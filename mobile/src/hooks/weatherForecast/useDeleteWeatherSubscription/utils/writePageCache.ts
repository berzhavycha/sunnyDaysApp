...
export const writePageCache = (cache: ApolloCache<NormalizedCache>, paginationOptions: WeatherPaginationQueryOptionsState, data: UserCitiesWeatherQuery['userCitiesWeather']): void => {
    cache.writeQuery({

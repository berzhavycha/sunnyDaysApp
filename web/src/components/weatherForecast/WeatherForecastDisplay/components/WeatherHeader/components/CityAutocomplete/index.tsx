...
import { DEBOUNCE_DELAY, getCitiesByPrefix } from '@/services';
...
export const CityAutocomplete = forwardRef<CityRef, Props>(
  ({ formRef, errorMessage }, ref: Ref<CityRef>) => {
    ...
    const renderCityItem = (item: City): JSX.Element => (
      <CityAutocompleteItem {...item} onPressOutside={onPressOutside} onCitySelect={onCitySelect} />
    );

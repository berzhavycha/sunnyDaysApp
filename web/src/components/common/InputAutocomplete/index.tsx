import { faLocationPin, faLocationPinLock, faMapLocation, faSearch } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="absolute top-14 bg-white w-full z-10 rounded-xl">
                    {
                        data.map(item => {
                            return (
                                <div key={item as string} className="text-black py-3 px-4 flex gap-2 items-center hover:bg-gray-200">

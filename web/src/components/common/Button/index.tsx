...
export const Button: FC<Props> = ({ content, onClick, isActive, isDisabled }) => {
    ...
    const className = `bg-blue-${isDisabled ? 400 : 600} px-4 text-white py-2 rounded-xl border-2 ${isActive ? 'border-white' : 'border-blue-600'} hover:bg-blue-800 hover:border-blue-800`

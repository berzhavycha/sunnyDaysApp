...
export const CitySearchStatusDocument = {
  kind: 'Document',
  definitions: [
    {
      ...
      selectionSet: {
        kind: 'SelectionSet',
        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'citySearchStatus' } }],
      },
    },
  ],
} as unknown as DocumentNode<CitySearchStatusQuery, CitySearchStatusQueryVariables>;
